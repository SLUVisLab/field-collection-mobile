...
export type ElementName = Heading | 'a' | 'br' | 'div' | 'em' | 'li' | 'ol' | 'p' | 'span' | 'strong' | 'u' | 'ul';
export type MarkdownNode = ChildMarkdownNode | HtmlMarkdownNode | LineBreakMarkdownNode | ParentMarkdownNode;
