const SIDE_CAR_ENGINE_URL =
  'https://cdn.jsdelivr.net/npm/@getodk/xforms-engine@1.0.3/dist/index.js';

export const createWebViewSidecarHtml = () => `<!doctype html>
<html>
  <head>
    <meta charset="utf-8" />
    <meta name="viewport" content="width=device-width,initial-scale=1" />
    <title>M2.4 Headless XForms Sidecar</title>
  </head>
  <body>
    <script type="module">
      const BRIDGE_VERSION = "m2.4-bridge-v1";
      const ENGINE_URL = ${JSON.stringify(SIDE_CAR_ENGINE_URL)};
      ...
      // Generic external-resource seam. The engine calls fetchFormAttachment(url)
      // for each jr: URL a form references (e.g. jr://file-csv/plants.csv,
      // jr://images/silphium-reference.jpg). We resolve it from an in-memory map
      // keyed by filename (the jr: URL's trailing segment) and return a standard
      // Response — no Entity-specific logic; any CSV/media/resource works.
